...
func init() {
	...
	benchmarkCmd.Flags().IntVarP(&numIterations, "num-iterations", "n", 2, "Number of iterations to run (default: 2)")
	benchmarkCmd.Flags().IntVarP(&concurrency, "concurrency", "c", 1, "Number of concurrent requests (default: 1)")
	benchmarkCmd.Flags().IntVarP(&meanInputTokens, "mean-input-tokens", "", 550, "Mean number of tokens to send in the prompt for the request (default: 550)")
	benchmarkCmd.Flags().IntVarP(&stddevInputTokens, "stddev-input-tokens", "", 150, "Standard deviation of number of tokens to send in the prompt for the request (default: 150)")
	benchmarkCmd.Flags().IntVarP(&meanOutputTokens, "mean-output-tokens", "", 150, "Mean number of tokens to generate from each LLM request (default: 150)")
	benchmarkCmd.Flags().IntVarP(&stddevOutputTokens, "stddev-output-tokens", "", 10, "Standard deviation on the number of tokens to generate per LLM request (default: 10)")
